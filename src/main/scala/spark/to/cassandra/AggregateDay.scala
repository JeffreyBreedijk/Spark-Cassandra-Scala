...
object AggregateDay {
  ...
  case class Consolidation(key:String, value: String, channel:String, start: String, end: String, sum: Double,  max: Double, min: Double, counter: Int)
      ...
      measurements
        ...
        .combineByKey(
          ...
          (daily1: (Double, Double, Double, Int), daily2: (Double, Double, Double, Int)) => (
            ...
            if (daily1._3 > daily2._3) daily1._3 else daily2._3,
            daily1._4 + daily2._4))
        .map(x => new Consolidation(x._1._1, x._1._2, x._1._3, start.toString, end.toString, x._2._1, x._2._2, x._2._3, x._2._4))
