...
object Aggregate {
  ...
  def main(args: Array[String]) {
    ...
    aggregate(measurements, tagcsv)

    def aggregate(measurements: RDD[(String, (Double, Double, Double, Int))],
      ...
      measurements
        ...
        .combineByKey(
          ...
          (daily1: (Double, Double, Double, Int), daily2: (Double, Double, Double, Int)) => (
            ...
            if (daily1._3 > daily2._3) daily1._3 else daily2._3,
            daily1._4 + daily2._4))
        .map(x => new Consolidation(x._1._1, x._1._2, start.value.toString, end.value.toString, x._2._1, x._2._2, x._2._3, x._2._4))
